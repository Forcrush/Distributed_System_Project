...
public class CreateWhiteBoard {
    ...
    public static void main(String args[]) {
        ...
        Thread sessT = new Thread(()-> ManPan(port));
        sessT.start();
...
//                    	os.flush();
    ...
    public static void ManPan(int port) {
    	String command;
        ...
        try (ServerSocket serverc = factoryc.createServerSocket(2129)) {
            ...
            while (true) {
                ...
                DataInputStream input = new DataInputStream(clientc.getInputStream());
                // Output Stream
                DataOutputStream output = new DataOutputStream(clientc.getOutputStream());
                command=input.readUTF();
                System.out.println(command);
           
                if((command.charAt(0)+":").equalsIgnoreCase("u:")) {
                	String uName= command.replace("u:", "");
                	User user = new User(uName, counter);
                ...
                }/*else if ((command.charAt(0)+":").equalsIgnoreCase("K:")){
                	output.writeUTF();
                	output.flush();
                }*/
            }
