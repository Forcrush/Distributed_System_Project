...
import ClientServer.SessionList;
import ClientServer.SessionManagerPanel;
...
public class WhiteBoard extends JFrame
{
    ...
    private String styleNames[] = {
        " å®‹ä½“ ", " éš¶ä¹¦ ", " Times New Roman ", " Serif ", 
    ...
    private SessionList sesslist;
    private SessionManagerPanel sessPanel;
    ...
    public void createWB() {
        ...
        for (int i = 0; i < choices.length; i++) {
            // å¦‚æžœåœ¨jbuilderä¸‹è¿�è¡Œæœ¬ç¨‹åº�ï¼Œåˆ™åº”è¯¥ç”¨è¿™æ�¡è¯­å�¥å¯¼å…¥å›¾ç‰‡
            // items[i] = new ImageIcon(WhiteBoard.class.getResource(names[i] +".gif"));
            // é»˜è®¤çš„åœ¨jdkæˆ–è€…jcreatorä¸‹è¿�è¡Œï¼Œç”¨æ­¤è¯­å�¥å¯¼å…¥å›¾ç‰‡
